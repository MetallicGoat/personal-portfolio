...
const MathProjectPage: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col items-center lg:flex-row lg:justify-around bg-slate-50 ease-in duration-300 dark:bg-gray-800 rounded-2xl">
        <div
          className="w-5/6 md:w-2/3 lg:w-2/5 xl:w-1/3 my-5 lg:m-5 border-gray-200 dark:border-gray-500 border-8 rounded-lg">
          <Graph
            graphInfo={graphInfo}
            version={version}
          />
        ...
        <div className="">
          ...
          {/*For smaller screens*/}
          <button
            className="lg:hidden ease-in duration-200 hover:scale-105 flex mx-auto bg-blue-500 hover:bg-blue-600 text-white text-lg px-4 py-1 mb-3 rounded"
            onClick={handleGraph}>
            Graph
          </button>
          ...
          <button
            className="hidden lg:block ease-in duration-200 hover:scale-105 mx-auto bg-blue-500 hover:bg-blue-600 text-white text-lg px-4 py-1 rounded m-2"
            onClick={handleGraph}>
            Graph
          </button>
        </div>
      ...
      <div className="flex justify-center">
        <a href="https://github.com/MetallicGoat/personal-portfolio" target="_blank"
           className="ease-in duration-200 hover:scale-105 text-center bg-green-600 hover:bg-green-700 text-white text-lg px-4 py-1 rounded m-4"
           rel="noreferrer">
          Source Code
        </a>
      </div>
